...
const typeNum = (arr) => {
  // Solution code here...
  let filteedArr = arr.filter(object=> typeof(object) === 'number')
  return filteedArr;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let andArr = arr.filter(ands => ands.includes('and'))
  return andArr;
...
const oddValues = (arr) => {
  // Solution code here...
  let oddArray = arr.filter(num => num%2)
  return oddArray ;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  let notFirstArray = arr.filter(num => !forbiddenValues.includes(num)  )
  return notFirstArray;
};
