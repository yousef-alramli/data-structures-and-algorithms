...
const fizzbuzz = (arr) => {
  ...
  let array =[];
  arr.forEach(num => {
    if (numper.isInteger((num/3)) && numper.isInteger((num/5))) {
      array.push('Fizz Buzz')
     
    }
else if (numper.isInteger((num/3))) {
  array.push('Fizz')
      
}
else if (numper.isInteger((num/5))) {
  array.push('Buzz')
