...
const addValues = (arr) => {
  // Solution code here...
  let array = arr.reduce((previousValue, currentValue) => previousValue + currentValue, 0);
...
const addPurchases = (arr) => {
  ...
  let array = arr.reduce((previousValue, currentValue) => {
    ...
    previousValue += currentValue.purchasePrice
...
const reversedString = (str) => {
  // Solution code here...
  let strings = str.split('').reduce((previousValue, currentValue) => {
